...
export type SerializedRef = SerializedPathRef | SerializedIdRef | SerializedTextSpanRef;
...
export declare class IdRef<Value = unknown, Doc = unknown, Fields extends symbol = never> extends Ref<Value, Doc, Fields> {
    #private;
